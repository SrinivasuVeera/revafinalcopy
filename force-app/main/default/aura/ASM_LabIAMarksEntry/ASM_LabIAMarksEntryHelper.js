({
    ...
    calcTotalHpr : function(component, event, helper) {
       ...
       // alert(JSON.stringify(marksList));
        for(var i=0;i<marksList.length;i++){
            ...
            iam.iaMark.Total_Secured_Marks_New__c = parseFloat(knldg)+parseFloat(exec)+parseFloat(desc)+parseFloat(viva)+parseFloat(punc)+parseFloat(result)+parseFloat(theory)+parseFloat(seminar)+parseFloat(quiz)+parseFloat(project)+parseFloat(assignment);
            iam.total = parseFloat(knldg)+parseFloat(exec)+parseFloat(desc)+parseFloat(viva)+parseFloat(punc)+parseFloat(result)+parseFloat(theory)+parseFloat(seminar)+parseFloat(quiz)+parseFloat(project)+parseFloat(assignment);
        }
    ...
    saveIaMarksHpr : function(component, event, helper) {
        ...
        if(errorCount > 0){
            ...
            for(var i=0;i<marksList.length;i++) {
                var iam = marksList[i];
               // if(iam.iaMark.Id != null){ // || (iam.total != undefined && iam.total != null)
