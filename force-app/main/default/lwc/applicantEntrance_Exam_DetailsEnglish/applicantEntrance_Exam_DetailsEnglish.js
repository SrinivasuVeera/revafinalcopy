...
import { OMNIDEF } from './applicantEntrance_Exam_DetailsEnglish_def.js';
import tmpl from './applicantEntrance_Exam_DetailsEnglish.html';
import tmpl_nds from './applicantEntrance_Exam_DetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicantEntrance_Exam_DetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
